	...
	<div class="container">
		...
		<div class="main-container">
			<form class="mypage-form" action="/ssa/api/mypage/edit" method="post">
				<h1>Mypage</h1>
				<input class="mypage-input" name="username" placeholder="username" value="<%=user.getUsername() %>" disabled="disabled">
			...
			<form class="mypage-form" action="/ssa/api/mypage/password/edit"
				method="post">
				<h1>Edit Password</h1>
				<input type="password" class="mypage-input" name="password" placeholder="password"> 
				<input type="password" class="mypage-input" name="checkPassword" placeholder="chechk-password">
				<button class="submit-button">변경하기</button>
			</form>
		</div>
	</div>
